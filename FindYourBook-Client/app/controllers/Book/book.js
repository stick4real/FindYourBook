...
$.buy_button.addEventListener('click', function (e){
	Alloy.createController('Book/buyBook', {id: args.id}).getView().open();
});

$.sell_button.addEventListener('click', function (e){
	$.sell_button.removeEventListener('click', arguments.callee);
	$.scrollBook.add(Alloy.createController('Book/sellBook', {id: args.id, title: args.title, author: args.author, img: args.img, description: args.description}).getView());
});