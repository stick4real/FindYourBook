...
exports.getBook = function(req, res) {
  ...
  Book.findById({ userId: req.user._id, _id: req.params.beer_id }, function(err, book) {
    if (err)
      res.send(err);
...
exports.deleteBook = function(req, res) {
  ...
  Book.findByIdAndRemove({ userId: req.user._id, _id: req.params.beer_id }, function(err) {
    if (err)
      res.send(err);
